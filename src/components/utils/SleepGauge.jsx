...
const SleepGauge = ({ value, onChange }) => {
  ...
  const getColor = (hours) => {
    if (hours < 6) return '#f56565'; // Red for less than 6h
    if (hours < 7) return '#ed8936'; // Orange for 6-7h  
    if (hours < 9) return '#48bb78'; // Green for 7-9h
    if (hours < 10) return '#eab308'; // Yellow for 9-10h
    return '#f56565'; // Red for 10h-11h+
  };
  ...
  return (
    <div className="flex flex-col items-center select-none">
      ...
      >
        ...
        >
          <div 
            className="absolute bg-[var(--nm-text-color)] transition-all duration-500"
            style={{ 
              width: '3px', 
              height: '50px', 
              top: '30px',
